...
const SignUpTermsAndCondition = (props) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          <h2>Welcome to Hindustan</h2>
          <p>These terms and conditions outline the rules and regulations for the use of Hindustan's Website.</p>
          {' '}
          <br />
          <span style={{ textTransform: 'capitalize' }}> Hindustan</span>
          {' '}
is located at:
          <br />
          <address>
          ...
          <p>
By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Hindustan's website
...
The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
	...
	capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.
          ...
          <h2>Cookies</h2>
          <p>
We employ the use of cookies. By using Hindustan's website you consent to the use of cookies
	in accordance with Hindustan's privacy policy.
...
Most of the modern day interactive web sites
	...
	affiliate / advertising partners may also use cookies.
          ...
          <h2>License</h2>
          <p>
Unless otherwise stated, Hindustan and/or it's licensors own the intellectual property rights for
	all material on Hindustan. All intellectual property rights are reserved. You may view and/or print
	pages from http://communitywebapp.s3-website.us-east-2.amazonaws.com/ for your own personal use subject to restrictions set in these terms and conditions.

          </p>
          <p>You must not:</p>
          <ol>
            <li>Republish material from http://communitywebapp.s3-website.us-east-2.amazonaws.com/</li>
            <li>Sell, rent or sub-license material from http://communitywebapp.s3-website.us-east-2.amazonaws.com/</li>
            <li>Reproduce, duplicate or copy material from http://communitywebapp.s3-website.us-east-2.amazonaws.com/</li>
          </ol>
          <p>Redistribute content from Hindustan (unless content is specifically made for redistribution).</p>
...
We will approve link requests from these organizations if we determine that: (a) the link would not reflect
	...
	the visibility associated with the hyperlink outweighs the absence of Hindustan; and (d) where the
...
If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
	you must notify us by sending an e-mail to
            {' '}
            <a href="mailto:er.parag4184@hotmail.com" title="send an email to er.parag4184@hotmail.com">er.parag4184@hotmail.com</a>
.
...
By use of any other description of our Web site or material being linked to that makes sense within the
          ...
          <p>
No use of Hindustan's logo or other artwork will be allowed for linking absent a trademark license
	agreement.
...
generator. If you have
	any queries regarding any of our terms, please contact us.
      ...
      <DialogActions>
        ...
        <Button onClick={agreeAndCloseHandler} color="primary">
            Agree
        </Button>
      </DialogActions>
    </Dialog>
...
SignUpTermsAndCondition.propTypes = {
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  onAgreeClick: PropTypes.func.isRequired,
};

export default SignUpTermsAndCondition;
